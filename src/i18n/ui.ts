...
export const ui = {
  en: {
    ...
    'hero.title': 'Authorized Hyundai Dealer in Nizamabad — New Cars, Test Drives & Service',
  ...
  te: {
    ...
    'hero.title': 'నిజామాబాద్‌లో అధీకృత హ్యుండాయ్ డీలర్ — కొత్త కార్లు, టెస్ట్ డ్రైవ్ & సర్వీస్',
  ...
  hi: {
    ...
    'hero.title': 'निजामाबाद में अधिकृत हुंडई डीलर — नई कारें, टेस्ट ड्राइव और सर्विस',
